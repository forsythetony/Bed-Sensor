...
#define RTC_TWI					(&AVR32_TWI)
#define RTC_TWI_SDA_PIN			AVR32_TWI_SDA_0_0_PIN
#define RTC_TWI_SDA_FUNCTION	AVR32_TWI_SDA_0_0_FUNCTION
#define RTC_TWI_SCL_PIN			AVR32_TWI_SCL_0_0_PIN
#define RTC_TWI_SCL_FUNCTION	AVR32_TWI_SCL_0_0_FUNCTION
...
extern volatile uint16_t data_rdy;
